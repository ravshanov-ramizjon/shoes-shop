...
export const metadata = {
  ...
  description: 'ShoesStore — стильная и удобная обувь для женщин, мужчин и детей. Бесплатная доставка по Узбекистану. Новинки, скидки и большой выбор моделей.',
  keywords: [
    //  Основные слова
    'web site dev uz', 'ShoesStore', 'shoes store', 'обувь', 'купить обувь', 'интернет-магазин обуви', 'магазин обуви онлайн', 'обувь Узбекистан', 'обувь Ташкент', 'обувной магазин',
  ...
  other: {
    ...
    "yandex-verification": "7d07e590757bc733"
  },
}
